 ...
 * UtilIDCard
 * PROJECT_NAME: lazy
 * PACKAGE_NAME: com.lazy.util.IDCard
...
public class UtilIDCard {
    ...
    public static boolean verifyIDCard(String IDCard) {
        ...
        if (UtilTime.getDateByStr("" + _year + "-" + _month + "-" + _day).after(new Date()) || _year < 1900)
            return false;
        switch (_month) {
            case 4:
            case 6:
    ...
    public static Date getBirthdayDateByIDCard(String IDCard) {
        ...
        return UtilTime.getDateByStr(birthday);
    }
