...
<div>
    ...
    <div class="mymain centermy" style="margin-top: 50px">
        ...
        <form class="form-horizontal" action="${ctx}/user/update" onsubmit="return checkInput()" id="matchForm">
            ...
            <div name="memberForm">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input s required value="<%=user.getName()%>" name="name" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 form-inline">
                        <select required name="siling" class="form-control">
                            <%
                                for (int j = 1; j <= 40; j++) {
                                    if (user.getSiling() == j) {
                            %>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select required name="groupId" class="form-control">
                    ...
                    <div class="col-sm-4">
                        <select required name="companyId" class="form-control">
                            <option value="">--请选择--</option>
                            <%
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input required name="department" value="<%=user.getDepartment()%>"
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="" type="text" name="position"
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="${user.position}" type="text" name="position"
                               class="form-control" placeholder="职位">
                    </div>
                    <%
                        }
                ...
                <div class="form-group">
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="" name="idCard" type="text"
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="<%=user.getIdCard()%>" name="idCard" type="text"
                               class="form-control" placeholder="身份证号">
                    </div>
                    <%
                        }
                ...
                <div class="form-group">
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="" name="school" type="text"
                    ...
                    %>
                    <div class="col-sm-4">
                        <input required value="<%=user.getSchool()%>" name="school" type="text"
                               class="form-control" placeholder="毕业院校">
                    </div>
                    <%
                        }
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input required value="<%=user.getEmail()%>" name="email" type="text"
                               class="form-control" placeholder="邮箱地址">
                    </div>
                    <label class="col-sm-2 control-label">手机号码</label>
                    <div class="col-sm-4">
                        <input required value="<%=user.getPhone()%>" name="phone" type="text"
            ...
            <div class="center-block" style="margin-top: 100px">
                <div style="margin-bottom:100px;display: table;width: auto;margin-left: auto;margin-right: auto"
                     class="center-block">
                    <input id="submitBtn" class="btn btn-danger" value="修改" type="submit">
                    </input>
