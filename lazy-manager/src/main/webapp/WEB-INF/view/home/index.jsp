...
<div id="ajax-loader"
    ...
    <img src="${ctx}/static/img/ajax-loader.gif" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;"/>
</div>
<div class="wrapper">
    <!--头部信息-->
    <header class="main-header">
        <a href="#" target="_blank" class="logo">
            <span class="logo-mini">LY</span>
            <span class="logo-lg">Lazy<strong>后台</strong></span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${ctx}/static/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <div id="content-wrapper" class="content-wrapper">
        <div class="content-tabs">
            ...
            <nav class="page-tabs menuTabs">
                <div class="page-tabs-content" style="margin-left: 0px;">
                    <a href="javascript:;"  class="menuTab active" data-id="${ctx}/view/home/default">欢迎首页</a>
                    ...
                    <%--<a href="javascript:;" class="menuTab" data-id="/SystemManage/Duty/Index">岗位管理 <i--%>
                            <%--class="fa fa-remove"></i></a>--%>
                    <%--<a href="javascript:;" class="menuTab" data-id="/home/default">首页 <i class="fa fa-remove"></i></a>--%>
                </div>
            </nav>
        ...
        <div class="content-iframe" style="overflow: hidden;">
            <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                <iframe name="iframe" class="LRADMS_iframe" width="100%" height="100%" src="${ctx}/view/home/default" frameborder="0"
                        data-id="${ctx}/view/home/default"></iframe>
            </div>
        </div>
    </div>
</div>
